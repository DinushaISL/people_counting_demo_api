...
url = config.get('CountCam3', 'url')
port = config.get('CountCam3', 'port')
username = config.get('CountCam3', 'username')
password = config.get('CountCam3', 'password')
...
while True:
    ...
    config.read('conf.ini')
    cond = config.get('CountCam3', 'cond')
